@E2E @US24
Feature: US24 - TC09 | Birthplace kutusuna sayısal bir değer girilerek kayıt yapılamamalı

  @UI
  Scenario: WEB_sitesinde_birthplace_kutusuna_sayisal_deger_girilerek_kayit_yapilamamali
