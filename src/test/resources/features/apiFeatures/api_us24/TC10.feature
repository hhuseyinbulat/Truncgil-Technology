@E2E @US24
Feature: US24 - TC10 | Birthplace kutusuna sembol karakteri girilerek kayıt yapılamamalı

  @UI
  Scenario: WEB_sitesinde_birthplace_kutusuna_sembol_karakteri_girilerek_kayit_yapilamamali
