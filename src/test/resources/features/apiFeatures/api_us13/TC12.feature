@E2E @US13
Feature: US13 - TC12 | Email kutusuna @ işaretinden sonra sadece bir karakter girilerek kayıt yapılamamalı

  @UI
  Scenario: WEB_sitesinde_email_kutusuna_@_isaretinden_sonra_sadece_bir_karakter_girilerek_kayit_yapilamamali
    ...
    And Email kutusuna "jackson@g" girer
