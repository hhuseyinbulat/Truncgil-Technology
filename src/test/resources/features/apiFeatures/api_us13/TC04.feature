@E2E @US13
Feature: US13 - TC04 | Name kutusuna sembol karakteri girilerek kayıt yapılamamalı

  @UI
  Scenario: WEB_sitesinde_name_kutusuna_sembol_karakteri_girilerek_kayit_yapilamamali
