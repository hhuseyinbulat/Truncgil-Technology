@E2E @US13
Feature: US13 - TC11 | Birthplace kutusuna noktalama işareti girilerek kayıt yapılamamalı

  @UI
  Scenario: WEB_sitesinde_birthplace_kutusuna_noktalama_isareti_girilerek_kayit_yapilamamali
