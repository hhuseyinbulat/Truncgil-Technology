@E2E @US13
Feature: US13 - TC06 | Surname kutusuna sayısal bir değer girilerek kayıt yapılamamalı

  @UI
  Scenario: WEB_sitesinde_surname_kutusuna_sayisal_deger_girilerek_kayit_yapilamamali
    ...
    And Surname kutusuna "898" girer
