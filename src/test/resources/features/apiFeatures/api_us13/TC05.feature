@E2E @US13
Feature: US13 - TC05 | Name kutusuna noktalama işareti girilerek kayıt yapılamamalı

  @UI
  Scenario: WEB_sitesinde_name_kutusuna_noktalama_isareti_girilerek_kayit_yapilamamali
