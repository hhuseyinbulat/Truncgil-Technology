@E2E @US13
Feature: US13 - TC08 | Surname kutusuna noktalama işareti girilerek kayıt yapılamamalı

  @UI
  Scenario: WEB_sitesinde_surname_kutusuna_noktalama_isareti_girilerek_kayit_yapilamamali
