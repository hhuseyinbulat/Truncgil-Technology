...
Feature: US08-TC01 | Vice Dean ders olusturabilmelidir
  @UI
  Scenario:WEB_Lesson_Name_Compulsory_Credit_alanlari_eksiksiz_doldurulmali
...
@API
  Scenario: API_Lesson_Name_Compulsory_Credit_alan_verileri_ile_Responstaki_verilerin_ayni_oldugu_dogrulanir
