...
Feature: US08-TC01 | Vice Dean ders olusturabilmelidir
  @UI
  Scenario:WEB_Lesson_Name_noktalama_isaretleri_girilmemeli
...
@API
  Scenario: API_Lesson_Name_noktalama_isaretleri_kaydedilmemeli_ve_Responstaki_verilerin_ayni_oldugu_dogrulanir
